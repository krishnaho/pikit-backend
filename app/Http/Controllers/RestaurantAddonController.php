...
class RestaurantAddonController extends Controller
{
    ...
    public function viewAddonCategories()
    {
        ...
        $addonCategories = AddonCategory::where('restaurant_id', $restaurant->id)->get();
        return view('restaurantOwner.addonCategories.addonCategories', [
    ...
    public function viewAddons()
    {
        ...
        $restaurant = Restaurant::whereIn('id', $restaurantIds)->with('restaurantCategory')->first();
        $addons = Addon::get();
        $addonCategories = AddonCategory::where('restaurant_id',$restaurant->id)->where('is_active', 1)->get();
        return view('restaurantOwner.addons.addons', [
            'addons' => $addons,
            'addonCategories' => $addonCategories,
        ]);
    }
