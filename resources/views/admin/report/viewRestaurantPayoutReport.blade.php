                            ...
                            <div class='form-group row mb-2'>
                                ...
                                <div class="col-lg-6 d-flex justify-content-end align-items-end">
                                    ...
                                    <div class="col-lg-1 ms-4">
                                        <button type="submit" formaction="{{ route('admin.exportRestaurantPayout') }}"
                                            formmethod='POST' class="btn btn-success">Export </button>
                                    </div>
                                    <div style=" margin-left: 57px; ">
                                        <a href="{{ route('admin.viewCompletedRestaurantPayoutReport')}}" class="btn" style="background: #ffb800;color: white;border-color: #ffb800;">Completed Payouts</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            @foreach ($restaurants as $restaurant)
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <button type="button"
                                            class="btn btn-icon btn-primary btn-active-color-light btn-sm "
                                            data-bs-toggle="modal" data-bs-target="#viewOrders{{ $restaurant->id }}">
                                            <em class="icon ni ni-eye-fill white"></em>
                                        </button>
                                    </td>
                                </tr>
                            @endforeach
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.orderView', $order->unique_order_id) }}"
                                                    class="btn btn-icon btn-bg-primary btn-active-color-light btn-sm ">
                            ...
                            <form action="{{ route('admin.releasePayouts') }}" method="POST"
                                enctype="multipart/form-data">
                                <label class="form-label col-lg-2"> Message</label>
                        ...
                        @php
                            ...
                            $payout_amount = $restaurant->orders->sum('payout_amount');
                        @endphp
                        <input type="hidden" name="order_ids" value="{{ $order_ids }}">
                        <input type="hidden" name="restaurant_id" value="{{ $restaurant->id }}">
                        <input type="hidden" name="payout_amount" value="{{ $payout_amount }}">
