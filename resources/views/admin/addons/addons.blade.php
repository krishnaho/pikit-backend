            ...
            <div class="modal-dialog modal-dialog-top">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="{{ route('admin.deleteAddon', $addon->id) }}" type="button"
                    ...
                    <form action="{{ route('admin.updateAddon') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="modal-body ">
                            ...
                            <div class='form-group row mb-4 align-middle'>
                                ...
                                <div class="col-lg-6 mb-1">
                                    <label for='addon_category_id' class=" form-label">Restaurant </label>
                                    <select class="form-select js-select2" data-control="select2"
                                        ...
                                        data-dropdown-parent="#editAddon{{ $addon->id }}" data-allow-clear="true">
    ...
    <div class="modal fade" id="add_addon" tabindex="-1">
        <div class="modal-dialog modal-dialog-top modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.addAddon') }}" method="POST" enctype="multipart/form-data"
                    id="myForm">
                    @csrf
                    <div class="modal-body ">
                        <div class='form-group row mb-4 align-middle'>
