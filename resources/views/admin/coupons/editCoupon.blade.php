...
@section('content')
    <div class="nk-content-body">
        ...
        <div class="card">
            <form class="form" method="POST" action="{{ route('admin.updateCoupon') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card-body py-10 px-lg-17">
                    <div class='form-group row mb-4 align-middle'>
                        ...
                        <div id="restaurants" @if ($coupon->coupon_type == 'RESTAURANT') style="display: show" @else style="display: none" @endif class="col-lg-12 mb-2">
                                ...
                                <select class="form-select js-select2" data-control="select2" id="restaurant"
                                    ...
                                    @foreach ($restaurants as $restaurant)
                                        <option value="{{ $restaurant->id }}"
                                            @if (isset($coupon) && in_array($restaurant->id, $couponRestaurants)) selected @endif class="restaurant_selectbox">
                                            {{ $restaurant->name }}
                                        </option>
                                    @endforeach
                                </select>
                ...
                if ($('#type').val() == "ITEM") {
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            $.each(data, function(key, item) {
                                document.getElementById('restaurant_ids').innerHTML +=
