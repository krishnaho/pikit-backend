                        ...
                        <div class="px-3 ">
                            @foreach ($newScheduledOrders as $key => $order)
                                <div class="d-flex flex-column py-2">
                                    <div class="d-flex align-items-center">
                                        <em class="icon ni ni-user-alt-fill"></em>
                                        <span class="pl-2 text-dark text-uppercase">{{ $order->user?->name }}
                                        </span>
                                    </div>
                                    <div class="d-flex align-items-center flex-row justify-content-between mt-2">
                                        <span class="text-dark text-uppercase"> {{ $order->unique_order_id }}</span>
                                    ...
                                    <div
                                        class="d-flex align-items-center d-flex align-items-center flex-row justify-content-between justify-content-between mt-2">
                                        <div>
                                            @if ($order->schedule_date && $order->schedule_time)
                                                ...
                                                @if ($scheduleDate->diffInDays($currentDate) == 0 && $order->schedule_time)
