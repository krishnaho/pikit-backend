            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="d-flex align-items-center justify-content-between p-3">
                        ...
                        <span class="mt-7">
                            <a href="{{ route('admin.thermalPrint', $order->id) }}" target="_blank"
                                class="btn btn-info"><em class="icon ni ni-printer me-1"></em> Thermal Print</a>
                        </span>
                    ...
                    @if ($order->review)
                        ...
                        <div class="d-flex align-items-center justify-content-between p-3">
                            ...
                            Customer Review : <span>{{ $order->review->feedback }}

                                ({{ $order->review->rating }}<em class="icon ni ni-star-fill fs-6 pe-1"></em>)
                        ...
                        <div>
                            <div class="d-flex flex-column align-content-center justify-content-center align-items-end">
                                <div>
                                    ...
                                    <div class="d-flex flex-row align-items-center justify-content-between">
                                        <div class="flex-grow-1 text-right">
                                            <label for="" class="col-form-label p-0 fs-8 pe-2">Platform
                                                fee:</label>
                                        </div>
                                        <div class=" w-75px text-right fs-8">
