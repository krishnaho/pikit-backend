            ...
            <div class="modal-dialog modal-dialog-top">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="{{ route('admin.deleteItemCategory', $itemCategory->id) }}" type="button"
                            ...
                            <div class='form-group row mb-4 align-middle'>
                                ...
                                <div class="col-lg-6 mb-1">
                                    ...
                                    <select class="form-select js-select2" data-control="select2"
                                        ...
                                        data-dropdown-parent="#editItemCategory{{ $itemCategory->id }}" data-allow-clear="true">
                                        <option value="" disabled selected>Select An Option</option>
                                        @foreach ($restaurants as $restaurant)
                                            <option value="{{ $restaurant->id }}"
                                                @if ($itemCategory->restaurant_id == $restaurant->id) selected @endif>{{ $restaurant->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="col-lg-6 mb-1">
                                    ...
                                    value="{{ $itemCategory->description }}"   name='description' id='description'  />
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
    ...
    <div class="modal fade" id="add_item_category" tabindex="-1">
        <div class="modal-dialog modal-dialog-top modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.addItemCategory') }}" method="POST" enctype="multipart/form-data"
                    id="myForm">
                    @csrf
                    <div class="modal-body ">
                        <div class='form-group row mb-4 align-middle'>
                            ...
                            <div class="col-lg-6 mb-1">
                                ...
                                <select class="form-select js-select2" data-control="select2"
                                    data-placeholder="Select an option" id="restaurant_id" name='restaurant_id'
                                    data-dropdown-parent="#add_item_category" data-allow-clear="true">
                                    <option value="" disabled selected>Select An Option</option>
                                    @foreach ($restaurants as $restaurant)
    ...
    <script>
        $(document).ready(function() {
            var datatable = $('#restaurant_categories').DataTable({
                ...
                ajax: '{{ route('admin.getAllItemCategories') }}',
                columns: [{
                        data: 'id'
                    },
                    {
