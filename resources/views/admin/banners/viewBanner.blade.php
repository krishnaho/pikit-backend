    ...
    <div class="modal fade" id="add_banner" tabindex="-1">
        <div class="modal-dialog modal-dialog-top modal-xl">
            <div class="modal-content">
                ...
                <form class="form" method="POST" action="{{ route('admin.createBanner') }}"
                        ...
                        <div class='form-group row mb-4 align-middle'>
                            ...
                            <div class="col-lg-6 mb-1">
                                ...
                                <div class="">
                                    <select class="form-select js-select2" data-control="select2"
                                        data-dropdown-parent="#add_banner" data-placeholder="Select an option"
                                        name="type" id="type" required onchange="changeView();">
                                        <option value="MULTI_RESTAURANT"> Restaurants</option>
                                        <option value="ITEM">Item</option>
                                    </select>
                                </div>
                            </div>
                            <div id="restaurants" style="display: show" class="col-lg-12 mb-1">
                                <label for="restaurant_ids" class="form-label required">
                                    Banner Applicable Restaurants </label>
                                <div class="">
                                    <select class="form-select js-select2" data-control="select2" id="multi_restaurant"
                                        name="restaurant_ids[]" id="restaurant_ids" multiple
                                        data-dropdown-parent="#add_banner" data-placeholder="Select an option">
                                        @foreach ($restaurants as $restaurant)
                                            <option value="{{ $restaurant->id }}" class="multi_restaurant_selectbox">
                                                {{ $restaurant->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div id="single_restaurant" style="display: none" class="col-lg-12 mb-1">
                                <label for="restaurant_id" class="form-label required">
                                    Banner Single Restaurant </label>
                                <div>
                            ...
                            <div id="items" style="display: none" class="col-lg-12 mb-1">
                                ...
                                <div>
                                    <select class="form-select js-select2" data-control="select2" id="item_id"
                                        name="item_id[]" data-dropdown-parent="#add_banner" multiple
            ...
            <div class="modal-dialog modal-dialog-top">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="{{ route('admin.deleteBanner', $banner->id) }}" type="button"
    ...
    <script>
        $(document).ready(function() {
            var datatable = $('#banners').DataTable({
                ...
                ajax: '{{ route('admin.getAllBanners') }}',
                columns: [{
                        data: 'id'
                    },
                    {
        ...
        $(document).ready(function() {
            $(document).on('change', '#restaurant_category_id , #city_id  , #type', function() {
                if ($('#type').val() == "ITEM") {
                    $.ajax({
                        type: "get",
                        url: '{{ url('/admin/get-restaurant-category-items') }}',
                        data: {
                    ...
                    $.ajax({
                        type: "get",
                        url: '{{ url('/admin/get-restaurant-category-restaurants') }}',
                        data: {
                            restaurant_category_id: $('#restaurant_category_id').val(),
                            city_id: $('#city_id').val(),
                        },
                    ...
                    $.ajax({
                        type: "get",
                        url: '{{ url('/admin/get-restaurant-category-restaurant') }}',
                        data: {
                            restaurant_category_id: $('#restaurant_category_id').val(),
                            city_id: $('#city_id').val(),
                        },
