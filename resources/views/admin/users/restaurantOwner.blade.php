        ...
        <div class="nk-block-head nk-block-head-sm">
            <div class="nk-block-between">
                <div class="nk-block-head-content">
                    <h4 class="nk-block-title page-title">Restaurant Owners</h4>
                </div>
                <div class="nk-block-head-content">
        ...
        <div class="modal-dialog modal-dialog-top modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add Restaurant Owner</h5>
                ...
                <form action="{{ route('admin.addUser') }}" method="POST" enctype="multipart/form-data" id="myForm">
                    ...
                    <div class="modal-body ">
                        ...
                        <input type="hidden" name="role" value="Restaurant Owner" />
                    </div>
    ...
    <script>
        $(document).ready(function() {
            var datatable = $('#users').DataTable({
                ...
                ajax: '{{ route('admin.getAllRestaurantOwners') }}',
                columns: [
