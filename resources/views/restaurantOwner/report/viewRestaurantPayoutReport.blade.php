                            ...
                            <div class='form-group row mb-2'>
                                ...
                                <div class="col-lg-6 d-flex justify-content-end align-items-end">
                                    ...
                                    <div style=" margin-left: 57px; ">
                                        <a href="{{ route('restaurantOwner.viewCompletedRestaurantPayoutReport')}}" class="btn" style="background: #ffb800;color: white;border-color: #ffb800;">Completed Payouts</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="table-responsive">
                            ...
                            <form action="{{ route('restaurantOwner.releaseRestaurantPayouts') }}" method="POST"
