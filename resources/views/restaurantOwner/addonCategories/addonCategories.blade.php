            ...
            <div class="modal-dialog modal-dialog-top">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="{{ route('restaurantOwner.deleteAddonCategory', $addonCategory->id) }}" type="button"
        ...
        <div class="modal fade" id="editAddonCategory{{ $addonCategory->id }}" tabindex="-1">
            <div class="modal-dialog modal-dialog-top modal-lg">
                <div class="modal-content">
                    ...
                    <form action="{{ route('restaurantOwner.updateAddonCategory') }}" method="POST" enctype="multipart/form-data"
                        id="myForm">
                        @csrf
                        <div class="modal-body ">
    ...
    <div class="modal fade" id="add_addon_category" tabindex="-1">
        <div class="modal-dialog modal-dialog-top modal-lg">
            <div class="modal-content">
                ...
                <form action="{{ route('restaurantOwner.addAddonCategory') }}" method="POST" enctype="multipart/form-data"
                    id="myForm">
                    @csrf
                    <div class="modal-body ">
                        <div class='form-group row mb-4 align-middle'>
    ...
    <script>
        $(document).ready(function() {
            var datatable = $('#addon_categories').DataTable({
                ...
                ajax: '{{ route('restaurantOwner.getAllAddonCategories') }}',
                columns: [{
                        data: 'id'
                    },
                    {
