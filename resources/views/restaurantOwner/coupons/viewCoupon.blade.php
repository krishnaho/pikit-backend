    ...
    <div class="modal fade" id="add_Coupon" tabindex="-1">
        <div class="modal-dialog modal-dialog-top modal-xl">
            <div class="modal-content">
                ...
                <form class="form" method="POST" action="{{ route('restaurantOwner.createCoupon') }}"
            ...
            <div class="modal-dialog modal-dialog-top">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="{{ route('restaurantOwner.deleteCoupon', $coupon->id) }}" type="button"
    ...
    <script>
        $(document).ready(function() {
            var datatable = $('#coupons').DataTable({
                ...
                ajax: '{{ route('restaurantOwner.getAllCoupons') }}',
                columns: [{
                        data: 'id'
                    },
                    {
