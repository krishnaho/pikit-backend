                        ...
                        <div class="nk-ecwg nk-ecwg3">
                            <div class="card-inner">
                                <div class="card-title-group">
                                    ...
                                    <div>
                                        <em class="icon ni ni-list-round" style="font-size: 30px"></em>
                                    </div>
                                </div>
                                <div class="data">
                                    <div class="amount">{{ $totalUsers->count() }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card h-100">
                        <div class="nk-ecwg nk-ecwg3">
                            <div class="card-inner">
                                <div class="card-title-group">
                                    <div class="card-title">
                                        <h6 class="title">Running Orders</h6>
                                    </div>
                                    <div>
                                        <em class="icon ni ni-list-fill" style="font-size: 30px"></em>
                                    </div>
                                </div>
                                <div class="data">
                                    <div class="amount"> {{ $runningOrders->count() }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-full">
                        ...
                        <div class="nk-tb-list mt-n2">
                            <div class="nk-tb-item nk-tb-head">
                                ...
                                <div class="nk-tb-col tb-col-sm fw-bolder fs-6 text-muted"><span>Payment Mode</span></div>
                                <div class="nk-tb-col tb-col-sm fw-bolder fs-6 text-muted"><span>Payment Status</span></div>
                            ...
                            @foreach ($orders as $order)
                                <div class="nk-tb-item">
                                    ...
                                    <div class="nk-tb-col"><span> {{ $order->payment_mode }}</span></div>
                                    <div class="nk-tb-col"><span> {{ $order->payment_status }}</span></div>
