                    ...
                    <form action="{{ route('admin.updateItemGroup') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="modal-body ">
                            ...
                            <div class='form-group row mb-4 align-middle'>
                                ...
                                <div class="col-lg-6 mb-1">
                                    <label for='background_image' class="required form-label">Background Image</label>
                                    <input type="file" class="form-control" placeholder="Background Image" name='background_image'
                                        id='background_image' />
                                </div>
                                <div class="col-lg-6 mb-1">
                                    <label class="required form-label">Current Image</label>
                                    <div >
                                        @if ($itemGroup->image)
                                ...
                                <div class="col-lg-6 mb-1">
                                    <label class="required form-label">Current Background Image</label>
                                    <div >
    ...
    <script>
        $(document).ready(function() {
            var datatable = $('#item_group').DataTable({
                ...
                ajax: '{{ route('restaurantOwner.getAllItemGroups') }}',
                columns: [{
                        data: 'id'
                    },
                    {
